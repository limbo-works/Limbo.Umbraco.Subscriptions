...
namespace Limbo.MailSystem.MailSegments.Services {
    ...
    public class MailSegmentService : CrudServiceBase<MailSegment, IMailSegmentRepository>, IMailSegmentService {
        /// <inheritdoc/>
        public MailSegmentService(IMailSegmentRepository repository, ILogger<ServiceBase<IMailSegmentRepository>> logger, DataAccessSettings dataAccessSettings) : base(repository, logger, dataAccessSettings) {
        }
    }
}
