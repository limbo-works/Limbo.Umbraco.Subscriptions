...
namespace Limbo.MailSystem.SegmentTypes.Services {
    ...
    public class SegmentTypeService : CrudServiceBase<SegmentType, ISegmentTypeRepository>, ISegmentTypeService {
        /// <inheritdoc/>
        public SegmentTypeService(ISegmentTypeRepository repository, ILogger<ServiceBase<ISegmentTypeRepository>> logger, DataAccessSettings dataAccessSettings) : base(repository, logger, dataAccessSettings) {
        }
    }
}
